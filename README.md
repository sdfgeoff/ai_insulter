...
## Configuration
- Set your API endpoint in the code (default: `http://localhost:1234/v1/chat/completions`).

## Customization
- Modify the insult logic or history length in the source code as needed.
